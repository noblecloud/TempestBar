...
class Ui_info(object):
    def setupUi(self, info):
        ...
        self.airGroup.setStyleSheet(u"QGroupBox{padding-top:2px; margin-top:-2px}\n"
"QGroupBox::title { \n"
...
" } ")
        ...
        self.gridLayout_3.addItem(self.windSpacer, 3, 0, 1, 1)

        self.windAverages = QFrame(self.windGroup)
        self.windAverages.setObjectName(u"windAverages")
        sizePolicy1 = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.windAverages.sizePolicy().hasHeightForWidth())
        self.windAverages.setSizePolicy(sizePolicy1)
        font3 = QFont()
        ...
        self.gridLayout_3.addWidget(self.windAverages, 2, 0, 1, 1)

        self.windNow = QFrame(self.windGroup)
        ...
        self.formLayout.setWidget(1, QFormLayout.LabelRole, self.windLabel)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.wind)
        ...
        self.formLayout.setWidget(2, QFormLayout.LabelRole, self.windDirectionLabel)
        ...
        self.formLayout.setWidget(2, QFormLayout.FieldRole, self.windDirection)

        self.label = QLabel(self.windNow)
        ...
        self.label_2 = QLabel(self.windGroup)
        ...
        self.skyGroup.setStyleSheet(u"QGroupBox{padding-top:15px; margin-top:-15px}")
        ...
        self.lightning = QFrame(self.skyGroup)
        ...
        self.precipitation = QFrame(self.skyGroup)
    ...
    def retranslateUi(self, info):
        ...
        self.temperatureLabel.setText(QCoreApplication.translate("info", u"Temperature:", None))
        self.temperature.setText(QCoreApplication.translate("info", u"70\u00ba", None))
        self.temperature.setProperty("measurement", "")
        self.humidityLabel.setText(QCoreApplication.translate("info", u"Humidity:", None))
        self.humidity.setText(QCoreApplication.translate("info", u"75%", None))
        self.humidity.setProperty("measurement", QCoreApplication.translate("info", u"humidity", None))
        self.feelsLikeLabel.setText(QCoreApplication.translate("info", u"Feels Like:", None))
        self.feelsLike.setText(QCoreApplication.translate("info", u"70\u00ba", None))
        self.feelsLike.setProperty("measurement", QCoreApplication.translate("info", u"temperature", None))
        self.dewpointLabel.setText(QCoreApplication.translate("info", u"Dew Point:", None))
        self.dewpoint.setText(QCoreApplication.translate("info", u"59.2\u00ba", None))
        self.dewpoint.setProperty("measurement", QCoreApplication.translate("info", u"temperature", None))
        self.airDensityLabel.setText(QCoreApplication.translate("info", u"Air Density:", None))
        self.airDensity.setText(QCoreApplication.translate("info", u"1.18 oz/ft\u00b3", None))
        self.airDensity.setProperty("measurement", QCoreApplication.translate("info", u"pressure", None))
        self.pressureLabel.setText(QCoreApplication.translate("info", u"Pressure:", None))
        self.pressure.setText(QCoreApplication.translate("info", u"29.7 inHg", None))
        self.illuminanceLabel.setText(QCoreApplication.translate("info", u"Illuminance:", None))
        self.illuminance.setText(QCoreApplication.translate("info", u"91.2k lux", None))
        self.illuminance.setProperty("measurement", "")
        self.irradianceLabel.setText(QCoreApplication.translate("info", u"Radiation:", None))
        self.irradiance.setText(QCoreApplication.translate("info", u"858 W/m\u00b2", None))
        self.irradiance.setProperty("measurement", "")
        self.uvLabel.setText(QCoreApplication.translate("info", u"UV:", None))
        self.uv.setText(QCoreApplication.translate("info", u"5", None))
        self.uv.setProperty("measurement", "")
        self.lullLabel.setText(QCoreApplication.translate("info", u"Lull:", None))
        self.lull.setText(QCoreApplication.translate("info", u"0 mph", None))
        self.lull.setProperty("measurement", QCoreApplication.translate("info", u"lullSpeed", None))
        self.gustLabel.setText(QCoreApplication.translate("info", u"Gust:", None))
        self.gust.setText(QCoreApplication.translate("info", u"1.5 mph", None))
        self.gust.setProperty("measurement", QCoreApplication.translate("info", u"gustSpeed", None))
        self.windAverageLabel.setText(QCoreApplication.translate("info", u"Speed", None))
        self.windAverage.setText(QCoreApplication.translate("info", u"0.9 mph", None))
        self.windAverage.setProperty("measurement", QCoreApplication.translate("info", u"windAverage", None))
        self.windDirectionAverageLabel.setText(QCoreApplication.translate("info", u"Direction:", None))
        self.windDirectionAverage.setText(QCoreApplication.translate("info", u"NNE (22\u00ba)", None))
        self.windDirectionAverage.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
        self.windLabel.setText(QCoreApplication.translate("info", u"Speed:", None))
        self.wind.setText(QCoreApplication.translate("info", u"0 mph", None))
        self.wind.setProperty("measurement", QCoreApplication.translate("info", u"wind", None))
        self.windDirectionLabel.setText(QCoreApplication.translate("info", u"Direction:", None))
        self.windDirection.setText(QCoreApplication.translate("info", u"NE (39\u00ba)", None))
        self.windDirection.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
        self.label.setText(QCoreApplication.translate("info", u"Now", None))
        self.label_2.setText(QCoreApplication.translate("info", u"Average", None))
        self.lastStrikeLabel.setText(QCoreApplication.translate("info", u"Last Srike:", None))
        self.lastStrike.setText(QCoreApplication.translate("info", u"\u221e", None))
        self.lastStrike.setProperty("measurement", QCoreApplication.translate("info", u"wind", None))
        self.strikeDistanceLabel.setText(QCoreApplication.translate("info", u"Distance:", None))
        self.strikeDistance.setText(QCoreApplication.translate("info", u"\u221e", None))
        self.strikeDistance.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
        self.strikeEnergyLabel.setText(QCoreApplication.translate("info", u"Energy:", None))
        self.strikeEnergy.setText(QCoreApplication.translate("info", u"0", None))
        self.strikeEnergy.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
        self.strikeTotalLabel.setText(QCoreApplication.translate("info", u"Total:", None))
        self.strikeTotal.setText(QCoreApplication.translate("info", u"0", None))
        self.strikeTotal.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
        self.rateLabel.setText(QCoreApplication.translate("info", u"Rate:", None))
        self.rate.setText(QCoreApplication.translate("info", u"0 in/hr", None))
        self.rate.setProperty("measurement", QCoreApplication.translate("info", u"wind", None))
        self.rateDescription.setText(QCoreApplication.translate("info", u"None", None))
        self.rateDescription.setProperty("measurement", QCoreApplication.translate("info", u"wind", None))
        self.accumulationLabel.setText(QCoreApplication.translate("info", u"Total:", None))
        self.accumulation.setText(QCoreApplication.translate("info", u"0 in", None))
        self.accumulation.setProperty("measurement", QCoreApplication.translate("info", u"windDirection", None))
    # retranslateUi
