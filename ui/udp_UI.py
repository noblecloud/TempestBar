...
class Ui_udp(object):
    ...
    def retranslateUi(self, udp):
        ...
        self.strikeDistance.setProperty("measurement", QCoreApplication.translate("udp", u"lightningDistance", None))
        self.precipRateLabel.setText(QCoreApplication.translate("udp", u"Precipitation Rate", None))
        self.precipRate.setText("")
        self.precipRate.setProperty("measurement", QCoreApplication.translate("udp", u"precipitationHourlyRaw", None))
        self.strikeDistanceLabel.setText(QCoreApplication.translate("udp", u"Strike Distance:", None))
        self.strikes.setText("")
        self.strikes.setProperty("measurement", QCoreApplication.translate("udp", u"lightning", None))
        self.strikesLabel.setText(QCoreApplication.translate("udp", u"Strikes:", None))
        ...
        self.groupBox.setTitle(QCoreApplication.translate("udp", u"Now", None))
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("udp", u"Averages", None))
