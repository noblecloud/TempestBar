...
################################################################################
## Form generated from reading UI file 'socketTab.ui'
##
...
class Ui_socketTab(object):
    def setupUi(self, socketTab):
        if not socketTab.objectName():
            socketTab.setObjectName(u"socketTab")
        socketTab.resize(950, 377)
        sizePolicy = QSizePolicy(QSizePolicy.Maximum, QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(socketTab.sizePolicy().hasHeightForWidth())
        socketTab.setSizePolicy(sizePolicy)
        socketTab.setMinimumSize(QSize(630, 368))
        self.horizontalLayout = QHBoxLayout(socketTab)
        self.horizontalLayout.setSpacing(0)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setSizeConstraint(QLayout.SetMinimumSize)
        self.horizontalLayout.setContentsMargins(5, 0, 5, 0)
        self.airGroup = QGroupBox(socketTab)
        ...
        self.windGroup = QGroupBox(socketTab)
        ...
        self.skyGroup = QGroupBox(socketTab)
        ...
        self.retranslateUi(socketTab)

        QMetaObject.connectSlotsByName(socketTab)
    # setupUi

    def retranslateUi(self, socketTab):
        socketTab.setWindowTitle(QCoreApplication.translate("socketTab", u"Form", None))
        self.airGroup.setTitle("")
        self.temperatureLabel.setText(QCoreApplication.translate("socketTab", u"Temperature:", None))
        self.temperature.setText(QCoreApplication.translate("socketTab", u"70\u00ba", None))
        self.temperature.setProperty("measurement", "")
        self.humidityLabel.setText(QCoreApplication.translate("socketTab", u"Humidity:", None))
        self.humidity.setText(QCoreApplication.translate("socketTab", u"75%", None))
        self.humidity.setProperty("measurement", QCoreApplication.translate("socketTab", u"humidity", None))
        self.feelsLikeLabel.setText(QCoreApplication.translate("socketTab", u"Feels Like:", None))
        self.feelsLike.setText(QCoreApplication.translate("socketTab", u"70\u00ba", None))
        self.feelsLike.setProperty("measurement", QCoreApplication.translate("socketTab", u"temperature", None))
        self.dewpointLabel.setText(QCoreApplication.translate("socketTab", u"Dew Point:", None))
        self.dewpoint.setText(QCoreApplication.translate("socketTab", u"59.2\u00ba", None))
        self.dewpoint.setProperty("measurement", QCoreApplication.translate("socketTab", u"temperature", None))
        self.airDensityLabel.setText(QCoreApplication.translate("socketTab", u"Air Density:", None))
        self.airDensity.setText(QCoreApplication.translate("socketTab", u"1.18 oz/ft\u00b3", None))
        self.airDensity.setProperty("measurement", QCoreApplication.translate("socketTab", u"pressure", None))
        self.pressureLabel.setText(QCoreApplication.translate("socketTab", u"Pressure:", None))
        self.pressure.setText(QCoreApplication.translate("socketTab", u"29.7 inHg", None))
        self.illuminanceLabel.setText(QCoreApplication.translate("socketTab", u"Illuminance:", None))
        self.illuminance.setText(QCoreApplication.translate("socketTab", u"91.2k lux", None))
        self.illuminance.setProperty("measurement", "")
        self.irradianceLabel.setText(QCoreApplication.translate("socketTab", u"Radiation:", None))
        self.irradiance.setText(QCoreApplication.translate("socketTab", u"858 W/m\u00b2", None))
        self.irradiance.setProperty("measurement", "")
        self.uvLabel.setText(QCoreApplication.translate("socketTab", u"UV:", None))
        self.uv.setText(QCoreApplication.translate("socketTab", u"5", None))
        self.uv.setProperty("measurement", "")
        self.windGroup.setTitle("")
        self.windNow.setTitle(QCoreApplication.translate("socketTab", u"Now", None))
        self.windLabel.setText(QCoreApplication.translate("socketTab", u"Speed:", None))
        self.wind.setText(QCoreApplication.translate("socketTab", u"0 mph", None))
        self.wind.setProperty("measurement", QCoreApplication.translate("socketTab", u"wind", None))
        self.windDirectionLabel.setText(QCoreApplication.translate("socketTab", u"Direction:", None))
        self.windDirection.setText(QCoreApplication.translate("socketTab", u"NE (39\u00ba)", None))
        self.windDirection.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
        self.windAverages.setTitle(QCoreApplication.translate("socketTab", u"Average", None))
        self.lullLabel.setText(QCoreApplication.translate("socketTab", u"Lull:", None))
        self.lull.setText(QCoreApplication.translate("socketTab", u"0 mph", None))
        self.lull.setProperty("measurement", QCoreApplication.translate("socketTab", u"lullSpeed", None))
        self.gustLabel.setText(QCoreApplication.translate("socketTab", u"Gust:", None))
        self.gust.setText(QCoreApplication.translate("socketTab", u"1.5 mph", None))
        self.gust.setProperty("measurement", QCoreApplication.translate("socketTab", u"gustSpeed", None))
        self.windAverageLabel.setText(QCoreApplication.translate("socketTab", u"Speed", None))
        self.windAverage.setText(QCoreApplication.translate("socketTab", u"0.9 mph", None))
        self.windAverage.setProperty("measurement", QCoreApplication.translate("socketTab", u"windAverage", None))
        self.windDirectionAverageLabel.setText(QCoreApplication.translate("socketTab", u"Direction:", None))
        self.windDirectionAverage.setText(QCoreApplication.translate("socketTab", u"NNE (22\u00ba)", None))
        self.windDirectionAverage.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
        self.skyGroup.setTitle("")
        self.precipitation.setTitle(QCoreApplication.translate("socketTab", u"Precipitation", None))
        self.rateLabel.setText(QCoreApplication.translate("socketTab", u"Rate:", None))
        self.rate.setText(QCoreApplication.translate("socketTab", u"0 in/hr", None))
        self.rate.setProperty("measurement", QCoreApplication.translate("socketTab", u"wind", None))
        self.rateDescription.setText(QCoreApplication.translate("socketTab", u"None", None))
        self.rateDescription.setProperty("measurement", QCoreApplication.translate("socketTab", u"wind", None))
        self.accumulationLabel.setText(QCoreApplication.translate("socketTab", u"Total:", None))
        self.accumulation.setText(QCoreApplication.translate("socketTab", u"0 in", None))
        self.accumulation.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
        self.lightning.setTitle(QCoreApplication.translate("socketTab", u"Lightning", None))
        self.lastStrikeLabel.setText(QCoreApplication.translate("socketTab", u"Last Srike:", None))
        self.lastStrike.setText(QCoreApplication.translate("socketTab", u"\u221e", None))
        self.lastStrike.setProperty("measurement", QCoreApplication.translate("socketTab", u"wind", None))
        self.strikeDistanceLabel.setText(QCoreApplication.translate("socketTab", u"Distance:", None))
        self.strikeDistance.setText(QCoreApplication.translate("socketTab", u"\u221e", None))
        self.strikeDistance.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
        self.strikeEnergyLabel.setText(QCoreApplication.translate("socketTab", u"Energy:", None))
        self.strikeEnergy.setText(QCoreApplication.translate("socketTab", u"0", None))
        self.strikeEnergy.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
        self.strikeTotalLabel.setText(QCoreApplication.translate("socketTab", u"Total:", None))
        self.strikeTotal.setText(QCoreApplication.translate("socketTab", u"0", None))
        self.strikeTotal.setProperty("measurement", QCoreApplication.translate("socketTab", u"windDirection", None))
    # retranslateUi
